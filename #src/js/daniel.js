...
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    if (cropCoverPopup) {
      ...
      const coverInput = uploadInput.querySelector('input[name="cover"]');
          ...
          $.ajax({
            ...
            success: function (response) {
              ...
              if(response.status) {
                ...
                coverInput.value = response.file;
      ...
      inputPhoto.addEventListener('change', event => {
        ...
        cropBtn.addEventListener('click', () => {
          ...
          `;
                  ...
                  fileid.value = response.file;
    
                  div.appendChild(fileid);
    ...
    $("#collecting").validate({
      ...
      ignore: ":hidden,.unavailable,:disabled",
    ...
    $("#corporate").validate({
      ...
      ignore: ":hidden,:disabled,.unavailable",
    ...
    if (fileInputWraps.length != 0) {
      ...
      fileInputWraps.forEach(fileInputWrap => {
        ...
        const fileInput = fileInputWrap.querySelector('input[name="file"]');
        ...
        input.addEventListener('change', function (e) {
          ...
          if(!/\.pdf|png|jpg|jpeg$/.test(file.name.toLowerCase())) {
    ...
    const item = $('.admin-filter');
    
    const filter = $('select', item);
    ...
    var adminTable = $('#admin-table').DataTable({
      ...
      ajax: {
        ...
        data: function(d) {
          ...
          d.finish = $('select[name="finish"]', item).val();
    
          d.status = $('select[name="status"]', item).val();
    
          d.type = $('select[name="type"]', item).val();
    
          d.goal = $('select[name="goal"]', item).val();
    ...
    */
    ...
    const fundTables = $('.admin-fund');
    
    var dataTables = {};
    
    fundTables.each(function(i, item){
      ...
      dataTables[id] = $('.fund-table', item).DataTable({
    ...
    $('div.stock', '.profile__cards').click(function(e){
        ...
        if(url !== '') {
          ...
          $('#view_action').attr('href', url);
    
        }
    
        $('input[name="actionid"]').val(id);
    
    });
    
    
    
    const inputDateCheckbox = document.querySelector('.input-date__checkbox input')
